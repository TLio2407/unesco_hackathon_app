...
const path = 'D:/Cuong/Project/unesco_hackathon_app/android/UNESCO_Requirement.pdf';
...
while ((match = regex.exec(content)) !== null) {
    ...
    try {
        ...
        console.log('--- Decompressed Stream ---');
        console.log(decompressed.toString('utf-8').replace(/[^\x20-\x7E\n]/g, ' '));
    } catch (e) {
